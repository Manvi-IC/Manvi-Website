...
export default function Hero() {
  ...
  return (
    <section className="max-w-[1700px] w-full mx-auto px-4 sm:px-6 py-6 font-sans">
      {/* Main Hero Grid */}
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
        
        {/* Left: Orange Form Card */}
        <div className="bg-[#f27a1a] rounded-[28px] p-6 sm:p-8 lg:p-10 flex flex-col justify-between min-h-[440px]">
        ...
        <div className="relative rounded-[28px] overflow-hidden min-h-[440px] bg-slate-700 flex flex-col justify-between">
          ...
          <div className="relative z-10 p-6 sm:p-8 lg:p-10 flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6 sm:gap-0">
            {/* WhatsApp spinning button */}
            <div className="w-[70px] h-[70px] sm:w-[80px] sm:h-[80px] relative flex items-center justify-center">
              <div className="absolute inset-0 bg-[#f27a1a] rounded-full" />
              <svg className="w-7 h-7 sm:w-8 sm:h-8 text-white z-10 relative" viewBox="0 0 24 24" fill="currentColor">

        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-16">
          ...
          <div className="md:col-span-5 flex flex-col gap-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex flex-col leading-none">
                <span className="text-[18px] font-extrabold text-white tracking-tight">Manvi</span>
                <span className="text-[11px] text-white font-bold uppercase tracking-wider mt-0.5">International Courier</span>
              </div>
            </div>
            <p className="text-white/80 text-[13px] italic leading-relaxed max-w-sm">
              Your Vision, Delivered with Care.
            </p>
            <p className="text-white/70 text-[12px] leading-relaxed max-w-sm">
              in 2023 by promoters with their 20+ years of experience in the express and freight industry.
            </p>
            
            {/* Social Icons */}
            <div className="flex items-center gap-4 mt-2">
              <span className="text-white/80 text-[13px] font-semibold">Social Network</span>
              <div className="flex gap-3">
                ...
                {/* Globe */}
                <a href="#" className="text-white hover:text-white/70 transition-colors">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"/></svg>
                </a>
              </div>
            </div>
          </div>
          ...
          <div className="md:col-span-3 flex flex-col gap-5">
            <div className="flex flex-col gap-3">
              <h3 className="text-[18px] font-extrabold text-white">Quick Links</h3>
          ...
          <div className="md:col-span-4 flex flex-col gap-5">
            <div className="flex flex-col gap-3">
              <h3 className="text-[18px] font-extrabold text-white">Office Info</h3>
              <div className="w-full h-[1px] bg-white/30" />
            </div>
            <div className="flex flex-col gap-5">
              <div className="flex items-center gap-4">
                <Phone className="w-[18px] h-[18px] text-white shrink-0" />
                <span className="text-[14px] text-white/85 font-medium">+91 7070-506070</span>
              </div>
              <div className="flex items-center gap-4">
                <Mail className="w-[18px] h-[18px] text-white shrink-0" />
                <span className="text-[14px] text-white/85 font-medium">info@manvi.com</span>
              </div>

...
> = {
  en: {
    ...
    perf_1: "99.97% Successful Delivery Rate",
  ...
  fr: {
    ...
    perf_1: "Taux de livraison réussie de 99.97 %",
  ...
  es: {
    ...
    perf_1: "Tasa de entrega exitosa del 99.97%",

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="group bg-white rounded-[32px] p-6 sm:p-8 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col justify-between min-h-[280px] sm:min-h-[340px] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_12px_32px_rgba(0,0,0,0.06)] hover:border-[#ff8a00]/30 cursor-pointer">
            ...
            <div className="flex flex-col items-end text-right mt-auto pt-8">
              <h3 className="text-[28px] sm:text-[32px] lg:text-[38px] font-extrabold text-[#ff8a00] leading-[1.1] tracking-tight">
          ...
          <div className="group bg-white rounded-[32px] p-6 sm:p-8 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] border border-gray-100 flex flex-col justify-between min-h-[280px] sm:min-h-[340px] transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_12px_32px_rgba(0,0,0,0.06)] hover:border-[#ff8a00]/30 cursor-pointer">
            ...
            <div className="flex flex-col items-end text-right mt-auto pt-8">
              <span className="text-[32px] sm:text-[36px] lg:text-[42px] font-extrabold text-[#ff8a00] leading-none tracking-tight">1000+</span>
              <div className="w-full h-[1.5px] bg-[#ff8a00]/30 my-4 transition-colors duration-300 group-hover:bg-[#ff8a00]/50" />
